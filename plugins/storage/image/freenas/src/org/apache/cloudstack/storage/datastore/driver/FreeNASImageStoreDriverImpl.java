...
public class FreeNASImageStoreDriverImpl extends CloudStackImageStoreDriverImpl {//extends BaseImageStoreDriverImpl {
    private static final Logger s_logger = Logger.getLogger(FreeNASImageStoreDriverImpl.class);
    ...
    public FreeNASImageStoreDriverImpl() {
    }
    ...
    public DataStoreTO getStoreTO(DataStore store) {
        ...
        FreeNASTO to = new FreeNASTO();
        to.setId(imgStore.getId());
        to.setUuid(imgStore.getUuid());

        return new FreeNASTO();
        */
        return super.getStoreTO(store);

    }
    public String createEntityExtractUrl(DataStore store, String installPath,
                                         ImageFormat format, DataObject dataObject) {
        return super.createEntityExtractUrl(store, installPath,format, dataObject );
    }

    //@Override
    public String createEntityExtractUrl2(DataStore store, String installPath, ImageFormat format, DataObject dataObject) {
