...
public class BHyveInvestigator extends AdapterBase implements Investigator {
    private final static Logger s_logger = Logger.getLogger(BHyveInvestigator.class);
    @Inject
