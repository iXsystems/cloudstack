...
public class BHyveHAConfig {




    public static final ConfigKey<Long> BhyveHAHealthCheckTimeout = new ConfigKey<>("Advanced", Long.class, "Bhyve.ha.health.check.timeout", "10",
            "The maximum length of time, in seconds, expected for an health check to complete.", true, ConfigKey.Scope.Cluster);

    public static final ConfigKey<Long> BhyveHAActivityCheckTimeout = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.activity.check.timeout", "60",
            "The maximum length of time, in seconds, expected for an activity check to complete.", true, ConfigKey.Scope.Cluster);

    public static final ConfigKey<Long> BhyveHAActivityCheckInterval = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.activity.check.interval", "60",
            "The interval, in seconds, between activity checks.", true, ConfigKey.Scope.Cluster);

    public static final ConfigKey<Long> BhyveHAActivityCheckMaxAttempts = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.activity.check.max.attempts", "10",
    ...
    public static final ConfigKey<Double> BhyveHAActivityCheckFailureThreshold = new ConfigKey<>("Advanced", Double.class, "bhyve.ha.activity.check.failure.ratio", "0.7",
    ...
    public static final ConfigKey<Long> BhyveHADegradedMaxPeriod = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.degraded.max.period", "300",
    ...
    public static final ConfigKey<Long> BhyveHARecoverTimeout = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.recover.timeout", "60",
            "The maximum length of time, in seconds, expected for a recovery operation to complete.", true, ConfigKey.Scope.Cluster);

    public static final ConfigKey<Long> BhyveHARecoverWaitPeriod = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.recover.wait.period", "600",
            "The maximum length of time, in seconds, to wait for a resource to recover.", true, ConfigKey.Scope.Cluster);

    public static final ConfigKey<Long> BhyveHARecoverAttemptThreshold = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.recover.failure.threshold", "1",
    ...
    public static final ConfigKey<Long> BhyveHAFenceTimeout = new ConfigKey<>("Advanced", Long.class, "bhyve.ha.fence.timeout", "60",
